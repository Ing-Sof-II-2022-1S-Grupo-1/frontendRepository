...
<body>
    <nav class="navbar sticky-top navbar-expand-lg" style="background: #315254; min-height: 120px">
        ...
        <span class="login">
            <a href="Panel-Administración.php">
                    ...
                    <form id="formLogin" method="POST">
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <p>Su contraseña debe tener entre 8 y 20 caracteres, puede contener letras o números; no debe contener espacios, caracteres especiales ni emoji.</p>
                            </div>
                        </div>
